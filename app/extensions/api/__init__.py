...
from app.core.http.exceptions.handler import handle_api_error, handle_error_422_400
...
def init_apis(app: Flask):
    ...
    app.register_error_handler(HTTPStatus.UNPROCESSABLE_ENTITY, handle_error_422_400)
    app.register_error_handler(HTTPStatus.BAD_REQUEST, handle_error_422_400)
