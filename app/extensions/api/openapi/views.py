...
<html>
  ...
  <body>
    <redoc spec-url='{{SWAGGER_JSON_URL}}'></redoc>
...
def swagger_json():
    return jsonify(open_api_docs.to_dict())


def swagger_ui():
    return render_template_string(
        SWAGGER_UI_HTML, **{"SWAGGER_JSON_URL": url_for("swaggger")}
    )


def redoc_ui():
    return render_template_string(REDOC_UI, **{"SWAGGER_JSON_URL": url_for("swaggger")})


def rapidoc_ui():
    return render_template_string(
        RAPI_DOC_UI, **{"SWAGGER_JSON_URL": url_for("swaggger")}
    )
