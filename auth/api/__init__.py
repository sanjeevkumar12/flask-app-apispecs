...
from .endpoints.register import RegisterAPIView, RegisterActivateAPIView
...
from .schema.register import LoginSchema, RegisterSchema, RegisterActivateUserSchema

openapi.open_api_docs.register_schema("Register", RegisterSchema)
openapi.open_api_docs.register_schema("RegisterActivateUser", RegisterActivateUserSchema)
